...
namespace Unicorn.Editor
{
    public partial class UnicornBuildSettings
    {
        private void ResetOthers()
        {
            ...
            var splashPrefab = AssetDatabase.LoadAssetAtPath<LoadingStartManager>("/Users/trung/Trung/UnicornStudio/BananaCatSur/Assets/Unicorn/Prefabs/AppOpen.prefab").GetComponentInChildren<Image>();
