...
namespace Unicorn
{
    ...
    public abstract class LevelManager : MonoBehaviour
    {
        ...
        public virtual void OnIngameUpdate()
        {

        }

        public virtual void OnIngameFixUpdate()
        {

        }

        public virtual void OnIngameLateUpdate()
        {

        }

        public virtual void OnLobbyUpdate()
        {

        }

        public virtual void OnLobbyFixed()
        {

        }

        public virtual void OnLobbyLateUpdate()
        {
