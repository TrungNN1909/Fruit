...
namespace Unicorn
{
    ...
    public partial class GameManager : SerializedMonoBehaviour
    {
        ...
        //Extra Code.
        [FoldoutGroup("Persistant Component")]
        [SerializeField] public UIGamePlayController uiGamePlayController;
        public UIGamePlayController GamePlayController => uiGamePlayController;

        [FoldoutGroup("Persistant Component")]
        [SerializeField] public UIHomeController uiHomeController;
        public UIHomeController HomeController => uiHomeController;

        public void HomeUIRegister(UIHomeController home)
        {
            uiHomeController = home;
        }

        public void GamePlayUIRegister(UIGamePlayController gameplay)
        {
            uiGamePlayController = gameplay;
        }
        ...
        public void Revive()
        {
            ...
            PlayingManager.Instance.Revive();
            // TODO: Revive code
        }
